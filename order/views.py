...
class InitiatePaymentView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        cus_postcode = request.POST.get('cus_postcode')
     ...
     # Get the campaign
        try:
            ...
            return JsonResponse({'error': campaign_id}, status=400)
