...
class InitiatePaymentView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        payload = {
            ...
            'currency': 'BDT',
            'tran_id': order_id,
            'success_url': 'https://donation-platform-backend-rmqk.onrender.com/api/transactions/payment-success/',
            'fail_url': 'https://donation-platform-backend-rmqk.onrender.com/api/transactions/payment-fail/',
            'cancel_url': 'https://donation-platform-backend-rmqk.onrender.com/api/transactions/payment-cancel/',
            'cus_name': cus_name,
            'cus_email': cus_email,
            'cus_phone': cus_phone,
            'cus_add1': cus_add1,
